...
| `make package-win-qt5` | Qt5 full-GUI Windows `.zip` (`jnext-<ver>-windows-x64-legacy.zip` in `build/win-qt5-release/`) — **Windows 7 SP1+** (GH #108 Phase A, see below) | Fedora MinGW **Qt5** cross toolchain (see below) | **Yes** (with the MinGW Qt5 packages installed) |
