...
| **Total**                                  |  4653 | 4401 |    0 |    5 |     247 |          0 |

Rows the sections above carry: **4653**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4385**. Rows the 107 suites declared in `test/unit-tests.conf` run live: **7683**.
