...
Rows the sections above carry: **4296**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4109**. Rows the 100 suites declared in `test/unit-tests.conf` run live: **7026**.
