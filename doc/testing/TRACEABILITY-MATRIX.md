...
Rows the sections above carry: **4535**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4295**. Rows the 105 suites declared in `test/unit-tests.conf` run live: **7512**.
