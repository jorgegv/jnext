...
Rows the sections above carry: **4341**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4154**. Rows the 100 suites declared in `test/unit-tests.conf` run live: **7071**.
