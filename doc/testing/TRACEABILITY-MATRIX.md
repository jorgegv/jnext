...
| **Total**                                  |  4224 | 3968 |    0 |    5 |     251 |          0 |

Rows the sections above carry: **4224**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4037**. Rows the 91 suites declared in `test/unit-tests.conf` run live: **6750**.
