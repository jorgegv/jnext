...
| **Total**                                  |  4502 | 4250 |    0 |    5 |     247 |          0 |

Rows the sections above carry: **4502**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4262**. Rows the 101 suites declared in `test/unit-tests.conf` run live: **7301**.
...
| SRST-10 | The border colour of the rows drawn before a mid-frame soft reset survives it; the rows from the reset row carry the reset register (zxnext.vhd:3587-3605,6370) | zxnext.vhd:3587-3605,6370 | pass | test/compositor/compositor_integration_test.cpp:1690 |
| SRST-11 | NR 0x4A / NR 0x68 b7 hold on the rows drawn before a mid-frame soft reset and take their reset values from the reset row (zxnext.vhd:5014,5026,6809,6823,6370) | zxnext.vhd:5014,5026,6809,6823,6370 | pass | test/compositor/compositor_integration_test.cpp:1710 |
| SRST-12 | The NR 0x15 layer priority holds on the rows drawn before a mid-frame soft reset, and reads back its reset value after the frame (zxnext.vhd:4948-4953,6799,6370) | zxnext.vhd:4948-4953,6799,6370 | pass | test/compositor/compositor_integration_test.cpp:1736 |
...
| SRST-17 | A soft reset leaves the FLASH phase running: frames 20..31 after a reset at frame 20 stay swapped, frame 32 is not (zxula.vhd:470,474-480 — no reset) | zxula.vhd:470,474-480 | pass | test/compositor/compositor_integration_test.cpp:1891 |
