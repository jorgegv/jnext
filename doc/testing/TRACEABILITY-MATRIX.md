...
Rows the sections above carry: **4473**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4264**. Rows the 105 suites declared in `test/unit-tests.conf` run live: **7478**.
