...
Rows the sections above carry: **4462**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4251**. Rows the 102 suites declared in `test/unit-tests.conf` run live: **7302**.
