...
| CTC+Interrupts                             |   207 |  192 |    0 |    0 |      15 |          0 |
...
| **Total**                                  |  4525 | 4273 |    0 |    5 |     247 |          0 |

Rows the sections above carry: **4525**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4291**. Rows the 105 suites declared in `test/unit-tests.conf` run live: **7505**.
