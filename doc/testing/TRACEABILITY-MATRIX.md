...
Rows the sections above carry: **4430**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4223**. Rows the 101 suites declared in `test/unit-tests.conf` run live: **7227**.
