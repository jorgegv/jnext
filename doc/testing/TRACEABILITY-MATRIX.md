...
Rows the sections above carry: **4261**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4074**. Rows the 99 suites declared in `test/unit-tests.conf` run live: **6972**.
