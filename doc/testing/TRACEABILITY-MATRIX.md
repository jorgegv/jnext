...
Rows the sections above carry: **4643**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4375**. Rows the 106 suites declared in `test/unit-tests.conf` run live: **7633**.
