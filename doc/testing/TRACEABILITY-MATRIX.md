...
| **Total**                                  |  4815 | 4673 |    0 |    5 |     137 |          0 |

Rows the sections above carry: **4815**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4510**. Rows the 115 suites declared in `test/unit-tests.conf` run live: **8368**.
