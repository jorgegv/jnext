...
| **Total**                                  |  4794 | 4676 |    0 |    5 |     113 |          0 |

Rows the sections above carry: **4794**. Distinct row IDs recorded anywhere in this document (every table, including "Extra coverage"): **4488**. Rows the 115 suites declared in `test/unit-tests.conf` run live: **8370**.
