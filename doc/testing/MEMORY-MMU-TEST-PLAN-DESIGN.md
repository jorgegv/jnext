...
Measured on main 2026-04-20 post-Phase-2-D2 merge:

- **145 plan rows total** (N8E-05 split into 05a/05b + CON-12 split into 12a/12b + L2M-02 split into 02a/02b in test — aggregated by matrix script per SUBLETTERS rule; 155 check()+skip() calls in test).
- **142 pass, 0 fail, 13 skip** (mmu_test binary); matrix plan-row aggregation **132 pass, 0 fail, 13 skip**.
