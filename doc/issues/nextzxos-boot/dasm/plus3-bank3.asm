                    ...
                    ld        (hl),e                        ;[09a5] 73
                    ld        (hl),e                        ;[09a6] 73
                    jr        nz,$09fb                      ;[09a7] 20 52
                    ld        b,l                           ;[09a9] 45
                    ld        b,e                           ;[09aa] 43
                    jr        nz,$09d3                      ;[09ab] 20 26
                    jr        nz,$09ff                      ;[09ad] 20 50
                    ld        c,h                           ;[09af] 4c
                    ld        b,c                           ;[09b0] 41
                    ld        e,c                           ;[09b1] 59
                    inc       l                             ;[09b2] 2c
                    jr        nz,$0a29                      ;[09b3] 20 74
                    ld        l,b                           ;[09b5] 68
                    ld        h,l                           ;[09b6] 65
                    ld        l,(hl)                        ;[09b7] 6e
                    ...
                    ld        h,c                           ;[1545] 61
                    ld        h,h                           ;[1546] 64
                    jr        nz,$1569                      ;[1547] 20 20
                    jr        nz,$156b                      ;[1549] 20 20
                    jr        nz,$156d                      ;[154b] 20 20
                    jr        nz,$156f                      ;[154d] 20 20
                    jr        nz,$1571                      ;[154f] 20 20
                    jr        nz,$1573                      ;[1551] 20 20
                    jr        nz,$14f5                      ;[1553] 20 a0
                    ld        a,$10                         ;[1555] 3e 10
                    ...
                    push      ix                            ;[386e] dd e5
                    call      $02bf                         ;[3870] cd bf 02
                    bit       4,(iy+$01)                    ;[3873] fd cb 01 66
                    jr        z,$387c                       ;[3877] 28 03
                    call      $387f                         ;[3879] cd 7f 38
                    pop       ix                            ;[387c] dd e1
                    ret                                     ;[387e] c9

                    ld        bc,$7ffd                      ;[387f] 01 fd 7f
                    ld        a,($5b5c)                     ;[3882] 3a 5c 5b
                    or        $07                           ;[3885] f6 07
                    out       (c),a                         ;[3887] ed 79
                    ld        a,($e600)                     ;[3889] 3a 00 e6
                    or        a                             ;[388c] b7
                    jr        z,$38ac                       ;[388d] 28 1d
                    ld        a,($5c78)                     ;[388f] 3a 78 5c
                    bit       0,a                           ;[3892] cb 47
                    jr        nz,$38ac                      ;[3894] 20 16
                    ld        a,($e600)                     ;[3896] 3a 00 e6
                    dec       a                             ;[3899] 3d
                    ld        ($e600),a                     ;[389a] 32 00 e6
                    jr        nz,$38ac                      ;[389d] 20 0d
                    ld        bc,$1ffd                      ;[389f] 01 fd 1f
                    ld        a,($5b67)                     ;[38a2] 3a 67 5b
                    and       $f7                           ;[38a5] e6 f7
                    ld        ($5b67),a                     ;[38a7] 32 67 5b
                    out       (c),a                         ;[38aa] ed 79
                    ld        bc,$7ffd                      ;[38ac] 01 fd 7f
                    ld        a,($5b5c)                     ;[38af] 3a 5c 5b
                    out       (c),a                         ;[38b2] ed 79
                    ret                                     ;[38b4] c9
                    ...
                    bit       4,(iy+$01)                    ;[3a29] fd cb 01 66
                    nop                                     ;[3a2d] 00
                    nop                                     ;[3a2e] 00
                    xor       a                             ;[3a2f] af
                    ld        de,$1536                      ;[3a30] 11 36 15
                    ret                                     ;[3a33] c9

                    ld        hl,$010f                      ;[3a34] 21 0f 01
                    ex        (sp),hl                       ;[3a37] e3
                    jp        $5b00                         ;[3a38] c3 00 5b
                    bit       4,(iy+$01)                    ;[3a3b] fd cb 01 66
                    nop                                     ;[3a3f] 00
                    nop                                     ;[3a40] 00
                    bit       7,(iy+$0a)                    ;[3a41] fd cb 0a 7e
                    ret                                     ;[3a45] c9

                    ld        hl,$0112                      ;[3a46] 21 12 01
                    jr        $3a37                         ;[3a49] 18 ec
                    bit       4,(iy+$01)                    ;[3a4b] fd cb 01 66
                    nop                                     ;[3a4f] 00
                    nop                                     ;[3a50] 00
                    rst       $18                           ;[3a51] df
                    cp        $0d                           ;[3a52] fe 0d
                    ...
                    ld        hl,$0115                      ;[3a55] 21 15 01
                    jr        $3a37                         ;[3a58] 18 dd
                    call      $028e                         ;[3a5a] cd 8e 02
                    ld        c,$00                         ;[3a5d] 0e 00
                    jr        nz,$3a6e                      ;[3a5f] 20 0d
                    call      $031e                         ;[3a61] cd 1e 03
                    jr        nc,$3a6e                      ;[3a64] 30 08
                    dec       d                             ;[3a66] 15
                    ld        e,a                           ;[3a67] 5f
                    call      $0333                         ;[3a68] cd 33 03
                    jp        $2657                         ;[3a6b] c3 57 26
                    bit       4,(iy+$01)                    ;[3a6e] fd cb 01 66
                    jp        z,$2660                       ;[3a72] ca 60 26
                    di                                      ;[3a75] f3
                    ei                                      ;[3a76] fb
                    jr        $3a79                         ;[3a77] 18 00
                    ld        c,$00                         ;[3a79] 0e 00
                    jp        $2660                         ;[3a7b] c3 60 26
                    cp        $a3                           ;[3a7e] fe a3
                    jr        z,$3a8e                       ;[3a80] 28 0c
                    cp        $a4                           ;[3a82] fe a4
                    jr        z,$3a8e                       ;[3a84] 28 08
                    sub       $a5                           ;[3a86] d6 a5
                    jp        nc,$0b5f                      ;[3a88] d2 5f 0b
                    jp        $0b56                         ;[3a8b] c3 56 0b
                    bit       4,(iy+$01)                    ;[3a8e] fd cb 01 66
                    jr        z,$3a86                       ;[3a92] 28 f2
                    ld        de,$3aa8                      ;[3a94] 11 a8 3a
                    push      de                            ;[3a97] d5
                    sub       $a3                           ;[3a98] d6 a3
                    ld        de,$3ab1                      ;[3a9a] 11 b1 3a
                    jr        z,$3aa2                       ;[3a9d] 28 03
                    ld        de,$3ab9                      ;[3a9f] 11 b9 3a
                    ld        a,$04                         ;[3aa2] 3e 04
                    push      af                            ;[3aa4] f5
                    jp        $0c17                         ;[3aa5] c3 17 0c
                    scf                                     ;[3aa8] 37
                    bit       1,(iy+$01)                    ;[3aa9] fd cb 01 4e
                    ret       nz                            ;[3aad] c0
                    jp        $0b03                         ;[3aae] c3 03 0b
                    ld        d,e                           ;[3ab1] 53
                    ld        d,b                           ;[3ab2] 50
                    ld        b,l                           ;[3ab3] 45
                    ld        b,e                           ;[3ab4] 43
                    ...
                    ld        d,d                           ;[3ab6] 52
                    ld        d,l                           ;[3ab7] 55
                    call      $4c50                         ;[3ab8] cd 50 4c
                    ld        b,c                           ;[3abb] 41
                    exx                                     ;[3abc] d9
                    jp        $3c01                         ;[3abd] c3 01 3c
                    nop                                     ;[3ac0] 00
                    nop                                     ;[3ac1] 00
                    nop                                     ;[3ac2] 00
                    nop                                     ;[3ac3] 00
                    ...
                    inc       de                            ;[3c01] 13
                    nop                                     ;[3c02] 00
                    ld        sp,$1339                      ;[3c03] 31 39 13
                    ld        bc,$3738                      ;[3c06] 01 38 37
                    nop                                     ;[3c09] 00
                    nop                                     ;[3c0a] 00
                    nop                                     ;[3c0b] 00
                    nop                                     ;[3c0c] 00
