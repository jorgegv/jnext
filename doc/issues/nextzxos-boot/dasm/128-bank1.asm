                    ...
                    push      ix                            ;[386e] dd e5
                    bit       4,(iy+$01)                    ;[3870] fd cb 01 66
                    jr        z,$3879                       ;[3874] 28 03
                    call      $3a42                         ;[3876] cd 42 3a
                    call      $02bf                         ;[3879] cd bf 02
                    pop       ix                            ;[387c] dd e1
                    ret                                     ;[387e] c9
                    ...
                    ld        l,a                           ;[38b0] 6f
                    jr        $3896                         ;[38b1] 18 e3
                    djnz      $38b3                         ;[38b3] 10 fe
                    ret                                     ;[38b5] c9

                    push      bc                            ;[38b6] c5
                    ld        b,$10                         ;[38b7] 06 10
                    call      $38b3                         ;[38b9] cd b3 38
                    pop       bc                            ;[38bc] c1
                    djnz      $38b6                         ;[38bd] 10 f7
                    ret                                     ;[38bf] c9

                    push      bc                            ;[38c0] c5
                    call      $389f                         ;[38c1] cd 9f 38
                    pop       bc                            ;[38c4] c1
                    and       $20                           ;[38c5] e6 20
                    jr        z,$38cb                       ;[38c7] 28 02
                    djnz      $38c0                         ;[38c9] 10 f5
                    ret                                     ;[38cb] c9

                    push      bc                            ;[38cc] c5
                    call      $389f                         ;[38cd] cd 9f 38
                    pop       bc                            ;[38d0] c1
                    and       $20                           ;[38d1] e6 20
                    jr        nz,$38d7                      ;[38d3] 20 02
                    djnz      $38cc                         ;[38d5] 10 f5
                    ret                                     ;[38d7] c9

                    call      $387f                         ;[38d8] cd 7f 38
                    ld        b,$01                         ;[38db] 06 01
                    jr        $38e4                         ;[38dd] 18 05
                    call      $387f                         ;[38df] cd 7f 38
                    ld        b,$04                         ;[38e2] 06 04
                    push      bc                            ;[38e4] c5
                    call      $389f                         ;[38e5] cd 9f 38
                    pop       bc                            ;[38e8] c1
                    and       $20                           ;[38e9] e6 20
                    jr        z,$392d                       ;[38eb] 28 40
                    xor       a                             ;[38ed] af
                    push      bc                            ;[38ee] c5
                    push      af                            ;[38ef] f5
                    call      $38ad                         ;[38f0] cd ad 38
                    ld        b,$a3                         ;[38f3] 06 a3
                    call      $38c0                         ;[38f5] cd c0 38
                    jr        nz,$392b                      ;[38f8] 20 31
                    call      $38a7                         ;[38fa] cd a7 38
                    jr        $3901                         ;[38fd] 18 02
                    rst       $38                           ;[38ff] ff
                    rst       $38                           ;[3900] ff
                    ld        b,$2b                         ;[3901] 06 2b
                    call      $38b3                         ;[3903] cd b3 38
                    call      $389f                         ;[3906] cd 9f 38
                    bit       5,a                           ;[3909] cb 6f
                    jr        z,$3911                       ;[390b] 28 04
                    pop       af                            ;[390d] f1
                    scf                                     ;[390e] 37
                    jr        $3914                         ;[390f] 18 03
                    pop       af                            ;[3911] f1
                    ...
                    rra                                     ;[3914] 1f
                    push      af                            ;[3915] f5
                    call      $38ad                         ;[3916] cd ad 38
                    ld        b,$26                         ;[3919] 06 26
                    call      $38b3                         ;[391b] cd b3 38
                    call      $38a7                         ;[391e] cd a7 38
                    ld        b,$23                         ;[3921] 06 23
                    call      $38b3                         ;[3923] cd b3 38
                    pop       af                            ;[3926] f1
                    pop       bc                            ;[3927] c1
                    djnz      $38ee                         ;[3928] 10 c4
                    ret                                     ;[392a] c9

                    pop       af                            ;[392b] f1
                    pop       bc                            ;[392c] c1
                    call      $38ad                         ;[392d] cd ad 38
                    xor       a                             ;[3930] af
                    ld        ($5b88),a                     ;[3931] 32 88 5b
                    inc       a                             ;[3934] 3c
                    scf                                     ;[3935] 37
                    ccf                                     ;[3936] 3f
                    ret                                     ;[3937] c9

                    call      $387f                         ;[3938] cd 7f 38
                    ld        a,($5b88)                     ;[393b] 3a 88 5b
                    and       $80                           ;[393e] e6 80
                    jr        nz,$3999                      ;[3940] 20 57
                    call      $389f                         ;[3942] cd 9f 38
                    and       $20                           ;[3945] e6 20
                    jr        z,$392d                       ;[3947] 28 e4
                    ld        a,($5b88)                     ;[3949] 3a 88 5b
                    and       a                             ;[394c] a7
                    jr        nz,$395a                      ;[394d] 20 0b
                    inc       a                             ;[394f] 3c
                    ld        ($5b88),a                     ;[3950] 32 88 5b
                    ld        a,$4c                         ;[3953] 3e 4c
                    ld        ($5b89),a                     ;[3955] 32 89 5b
                    jr        $399c                         ;[3958] 18 42
                    ld        a,($5b89)                     ;[395a] 3a 89 5b
                    dec       a                             ;[395d] 3d
                    ld        ($5b89),a                     ;[395e] 32 89 5b
                    jr        nz,$399c                      ;[3961] 20 39
                    xor       a                             ;[3963] af
                    ld        ($5b88),a                     ;[3964] 32 88 5b
                    ld        ($5b89),a                     ;[3967] 32 89 5b
                    ld        ($5b8a),a                     ;[396a] 32 8a 5b
                    call      $38a7                         ;[396d] cd a7 38
                    ld        b,$21                         ;[3970] 06 21
                    call      $38c0                         ;[3972] cd c0 38
                    jr        nz,$392d                      ;[3975] 20 b6
                    call      $38ad                         ;[3977] cd ad 38
                    ld        b,$24                         ;[397a] 06 24
                    call      $38cc                         ;[397c] cd cc 38
                    jr        z,$392d                       ;[397f] 28 ac
                    call      $38a7                         ;[3981] cd a7 38
                    ld        b,$0f                         ;[3984] 06 0f
                    call      $38b6                         ;[3986] cd b6 38
                    call      $38df                         ;[3989] cd df 38
                    jr        nz,$392d                      ;[398c] 20 9f
                    set       7,a                           ;[398e] cb ff
                    and       $f0                           ;[3990] e6 f0
                    ld        ($5b88),a                     ;[3992] 32 88 5b
                    xor       a                             ;[3995] af
                    srl       a                             ;[3996] cb 3f
                    ret                                     ;[3998] c9
                    ...
                    call      $3938                         ;[39a0] cd 38 39
                    ld        a,($5b88)                     ;[39a3] 3a 88 5b
                    cpl                                     ;[39a6] 2f
                    and       $c0                           ;[39a7] e6 c0
                    ret       nz                            ;[39a9] c0
                    ld        ix,$5b8a                      ;[39aa] dd 21 8a 5b
                    ld        b,$05                         ;[39ae] 06 05
                    push      bc                            ;[39b0] c5
                    call      $38d8                         ;[39b1] cd d8 38
                    jp        nz,$3a3a                      ;[39b4] c2 3a 3a
                    bit       7,a                           ;[39b7] cb 7f
                    jr        z,$39dc                       ;[39b9] 28 21
                    call      $38df                         ;[39bb] cd df 38
                    jr        nz,$3a3a                      ;[39be] 20 7a
                    pop       bc                            ;[39c0] c1
                    push      bc                            ;[39c1] c5
                    ld        c,a                           ;[39c2] 4f
                    ld        a,(ix+$00)                    ;[39c3] dd 7e 00
                    bit       0,b                           ;[39c6] cb 40
                    jr        z,$39d6                       ;[39c8] 28 0c
                    srl       c                             ;[39ca] cb 39
                    srl       c                             ;[39cc] cb 39
                    srl       c                             ;[39ce] cb 39
                    srl       c                             ;[39d0] cb 39
                    ...
                    and       $0f                           ;[39d6] e6 0f
                    or        c                             ;[39d8] b1
                    ld        (ix+$00),a                    ;[39d9] dd 77 00
                    pop       bc                            ;[39dc] c1
                    bit       0,b                           ;[39dd] cb 40
                    jr        nz,$39e3                      ;[39df] 20 02
                    dec       ix                            ;[39e1] dd 2b
                    djnz      $39b0                         ;[39e3] 10 cb
                    ld        e,$80                         ;[39e5] 1e 80
                    ld        ix,$5b88                      ;[39e7] dd 21 88 5b
                    ld        hl,$3a3f                      ;[39eb] 21 3f 3a
                    ld        b,$03                         ;[39ee] 06 03
                    ld        a,(ix+$00)                    ;[39f0] dd 7e 00
                    and       (hl)                          ;[39f3] a6
                    jr        z,$3a17                       ;[39f4] 28 21
                    bit       7,e                           ;[39f6] cb 7b
                    jr        z,$3a3c                       ;[39f8] 28 42
                    push      bc                            ;[39fa] c5
                    push      af                            ;[39fb] f5
                    ld        a,b                           ;[39fc] 78
                    jr        $3a01                         ;[39fd] 18 02
                    ...
                    pop       af                            ;[3a0b] f1
                    sla       a                             ;[3a0c] cb 27
                    jp        c,$3a13                       ;[3a0e] da 13 3a
                    djnz      $3a0c                         ;[3a11] 10 f9
                    ld        e,b                           ;[3a13] 58
                    pop       bc                            ;[3a14] c1
                    jr        nz,$3a3c                      ;[3a15] 20 25
                    inc       ix                            ;[3a17] dd 23
                    inc       hl                            ;[3a19] 23
                    djnz      $39f0                         ;[3a1a] 10 d4
                    bit       7,e                           ;[3a1c] cb 7b
                    jr        nz,$3a27                      ;[3a1e] 20 07
                    ld        a,e                           ;[3a20] 7b
                    and       $fc                           ;[3a21] e6 fc
                    jr        z,$3a27                       ;[3a23] 28 02
                    dec       e                             ;[3a25] 1d
                    dec       e                             ;[3a26] 1d
                    ld        a,($5b8a)                     ;[3a27] 3a 8a 5b
                    and       $08                           ;[3a2a] e6 08
                    jr        z,$3a34                       ;[3a2c] 28 06
                    ld        a,e                           ;[3a2e] 7b
                    and       $7f                           ;[3a2f] e6 7f
                    add       $12                           ;[3a31] c6 12
                    ld        e,a                           ;[3a33] 5f
                    ...
                    rrca                                    ;[3a3f] 0f
                    rst       $38                           ;[3a40] ff
                    jp        p,$801e                       ;[3a41] f2 1e 80
                    ld        a,($5c78)                     ;[3a44] 3a 78 5c
                    and       $01                           ;[3a47] e6 01
                    jr        nz,$3a4f                      ;[3a49] 20 04
                    call      $39a0                         ;[3a4b] cd a0 39
                    ret       nz                            ;[3a4e] c0
                    ld        hl,$5c00                      ;[3a4f] 21 00 5c
                    bit       7,(hl)                        ;[3a52] cb 7e
                    jr        nz,$3a62                      ;[3a54] 20 0c
                    ld        a,(hl)                        ;[3a56] 7e
                    cp        $5b                           ;[3a57] fe 5b
                    jr        c,$3a62                       ;[3a59] 38 07
                    inc       hl                            ;[3a5b] 23
                    dec       (hl)                          ;[3a5c] 35
                    dec       hl                            ;[3a5d] 2b
                    jr        nz,$3a62                      ;[3a5e] 20 02
                    ld        (hl),$ff                      ;[3a60] 36 ff
                    ld        a,l                           ;[3a62] 7d
                    ld        hl,$5c04                      ;[3a63] 21 04 5c
                    cp        l                             ;[3a66] bd
                    jr        nz,$3a52                      ;[3a67] 20 e9
                    call      $3aae                         ;[3a69] cd ae 3a
                    ret       nz                            ;[3a6c] c0
                    ld        a,e                           ;[3a6d] 7b
                    ld        hl,$5c00                      ;[3a6e] 21 00 5c
                    cp        (hl)                          ;[3a71] be
                    jr        z,$3a9e                       ;[3a72] 28 2a
                    ex        de,hl                         ;[3a74] eb
                    ld        hl,$5c04                      ;[3a75] 21 04 5c
                    cp        (hl)                          ;[3a78] be
                    jr        z,$3a9e                       ;[3a79] 28 23
                    bit       7,(hl)                        ;[3a7b] cb 7e
                    jr        nz,$3a83                      ;[3a7d] 20 04
                    ex        de,hl                         ;[3a7f] eb
                    bit       7,(hl)                        ;[3a80] cb 7e
                    ret       z                             ;[3a82] c8
                    ld        e,a                           ;[3a83] 5f
                    ...
                    ld        (hl),$0a                      ;[3a86] 36 0a
                    inc       hl                            ;[3a88] 23
                    ld        a,($5c09)                     ;[3a89] 3a 09 5c
                    srl       a                             ;[3a8c] cb 3f
                    ld        (hl),a                        ;[3a8e] 77
                    inc       hl                            ;[3a8f] 23
                    call      $3ad7                         ;[3a90] cd d7 3a
                    ld        (hl),e                        ;[3a93] 73
                    ld        a,e                           ;[3a94] 7b
                    ld        ($5c08),a                     ;[3a95] 32 08 5c
                    ld        hl,$5c3b                      ;[3a98] 21 3b 5c
                    set       5,(hl)                        ;[3a9b] cb ee
                    ret                                     ;[3a9d] c9
                    ...
                    jr        $3a94                         ;[3aac] 18 e6
                    ld        a,e                           ;[3aae] 7b
                    ld        hl,$5b66                      ;[3aaf] 21 66 5b
                    bit       0,(hl)                        ;[3ab2] cb 46
                    jr        z,$3abc                       ;[3ab4] 28 06
                    cp        $6d                           ;[3ab6] fe 6d
                    jr        nc,$3ad4                      ;[3ab8] 30 1a
                    xor       a                             ;[3aba] af
                    ret                                     ;[3abb] c9

                    cp        $80                           ;[3abc] fe 80
                    jr        nc,$3ad4                      ;[3abe] 30 14
                    cp        $6c                           ;[3ac0] fe 6c
                    jr        nz,$3aba                      ;[3ac2] 20 f6
                    nop                                     ;[3ac4] 00
                    nop                                     ;[3ac5] 00
                    nop                                     ;[3ac6] 00
                    nop                                     ;[3ac7] 00
                    ...
                    ld        d,$00                         ;[3adb] 16 00
                    ld        e,a                           ;[3add] 5f
                    ld        hl,$5b66                      ;[3ade] 21 66 5b
                    bit       0,(hl)                        ;[3ae1] cb 46
                    jr        z,$3aea                       ;[3ae3] 28 05
                    ld        hl,$3b13                      ;[3ae5] 21 13 3b
                    jr        $3b0f                         ;[3ae8] 18 25
                    ld        hl,$3b25                      ;[3aea] 21 25 3b
                    cp        $11                           ;[3aed] fe 11
                    jr        c,$3b0f                       ;[3aef] 38 1e
                    ld        hl,$3b21                      ;[3af1] 21 21 3b
                    cp        $15                           ;[3af4] fe 15
                    jr        z,$3b0f                       ;[3af6] 28 17
                    cp        $16                           ;[3af8] fe 16
                    jr        z,$3b0f                       ;[3afa] 28 13
                    jr        $3b01                         ;[3afc] 18 03
                    nop                                     ;[3afe] 00
                    rst       $38                           ;[3aff] ff
                    rst       $38                           ;[3b00] ff
                    cp        $17                           ;[3b01] fe 17
                    jr        z,$3b0f                       ;[3b03] 28 0a
                    ld        hl,$3b18                      ;[3b05] 21 18 3b
                    cp        $21                           ;[3b08] fe 21
                    jr        nc,$3b0f                      ;[3b0a] 30 03
                    ld        hl,$3b13                      ;[3b0c] 21 13 3b
                    add       hl,de                         ;[3b0f] 19
                    ld        e,(hl)                        ;[3b10] 5e
                    pop       hl                            ;[3b11] e1
                    ret                                     ;[3b12] c9
                    ...
                    ld        l,$0d                         ;[3b13] 2e 0d
                    inc       sp                            ;[3b15] 33
                    ld        ($2931),a                     ;[3b16] 32 31 29
                    jr        z,$3b45                       ;[3b19] 28 2a
                    cpl                                     ;[3b1b] 2f
                    dec       l                             ;[3b1c] 2d
                    add       hl,sp                         ;[3b1d] 39
                    jr        c,$3b57                       ;[3b1e] 38 37
                    dec       hl                            ;[3b20] 2b
                    ld        (hl),$35                      ;[3b21] 36 35
                    inc       (hl)                          ;[3b23] 34
                    jr        nc,$3acb                      ;[3b24] 30 a5
                    dec       c                             ;[3b26] 0d
                    and       (hl)                          ;[3b27] a6
                    and       a                             ;[3b28] a7
                    xor       b                             ;[3b29] a8
                    ...
                    or        e                             ;[3b39] b3
                    or        h                             ;[3b3a] b4
                    bit       4,(iy+$01)                    ;[3b3b] fd cb 01 66
                    jr        nz,$3b46                      ;[3b3f] 20 05
                    xor       a                             ;[3b41] af
                    ld        de,$1536                      ;[3b42] 11 36 15
                    ret                                     ;[3b45] c9

                    ld        hl,$010f                      ;[3b46] 21 0f 01
                    ex        (sp),hl                       ;[3b49] e3
                    jp        $5b00                         ;[3b4a] c3 00 5b
                    bit       4,(iy+$01)                    ;[3b4d] fd cb 01 66
                    jr        nz,$3b58                      ;[3b51] 20 05
                    bit       7,(iy+$0a)                    ;[3b53] fd cb 0a 7e
                    ret                                     ;[3b57] c9

                    ld        hl,$0112                      ;[3b58] 21 12 01
                    jr        $3b49                         ;[3b5b] 18 ec
                    bit       4,(iy+$01)                    ;[3b5d] fd cb 01 66
                    jr        nz,$3b67                      ;[3b61] 20 04
                    rst       $18                           ;[3b63] df
                    cp        $0d                           ;[3b64] fe 0d
                    ret                                     ;[3b66] c9

                    ld        hl,$0115                      ;[3b67] 21 15 01
                    jr        $3b49                         ;[3b6a] 18 dd
                    call      $028e                         ;[3b6c] cd 8e 02
                    ld        c,$00                         ;[3b6f] 0e 00
                    jr        nz,$3b80                      ;[3b71] 20 0d
                    call      $031e                         ;[3b73] cd 1e 03
                    jr        nc,$3b80                      ;[3b76] 30 08
                    dec       d                             ;[3b78] 15
                    ld        e,a                           ;[3b79] 5f
                    call      $0333                         ;[3b7a] cd 33 03
                    jp        $2657                         ;[3b7d] c3 57 26
                    bit       4,(iy+$01)                    ;[3b80] fd cb 01 66
                    jp        z,$2660                       ;[3b84] ca 60 26
                    di                                      ;[3b87] f3
                    call      $39a0                         ;[3b88] cd a0 39
                    ei                                      ;[3b8b] fb
                    jr        nz,$3b9a                      ;[3b8c] 20 0c
                    call      $3aae                         ;[3b8e] cd ae 3a
                    jr        nz,$3b9a                      ;[3b91] 20 07
                    call      $3ad7                         ;[3b93] cd d7 3a
                    ld        a,e                           ;[3b96] 7b
                    jp        $2657                         ;[3b97] c3 57 26
                    ld        c,$00                         ;[3b9a] 0e 00
                    jp        $2660                         ;[3b9c] c3 60 26
                    cp        $a3                           ;[3b9f] fe a3
                    jr        z,$3baf                       ;[3ba1] 28 0c
                    cp        $a4                           ;[3ba3] fe a4
                    jr        z,$3baf                       ;[3ba5] 28 08
                    sub       $a5                           ;[3ba7] d6 a5
                    jp        nc,$0b5f                      ;[3ba9] d2 5f 0b
                    jp        $0b56                         ;[3bac] c3 56 0b
                    bit       4,(iy+$01)                    ;[3baf] fd cb 01 66
                    jr        z,$3ba7                       ;[3bb3] 28 f2
                    ld        de,$3bc9                      ;[3bb5] 11 c9 3b
                    push      de                            ;[3bb8] d5
                    sub       $a3                           ;[3bb9] d6 a3
                    ld        de,$3bd2                      ;[3bbb] 11 d2 3b
                    jr        z,$3bc3                       ;[3bbe] 28 03
                    ld        de,$3bda                      ;[3bc0] 11 da 3b
                    ld        a,$04                         ;[3bc3] 3e 04
                    push      af                            ;[3bc5] f5
                    jp        $0c17                         ;[3bc6] c3 17 0c
                    scf                                     ;[3bc9] 37
                    bit       1,(iy+$01)                    ;[3bca] fd cb 01 4e
                    ret       nz                            ;[3bce] c0
                    jp        $0b03                         ;[3bcf] c3 03 0b
                    ld        d,e                           ;[3bd2] 53
                    ld        d,b                           ;[3bd3] 50
                    ld        b,l                           ;[3bd4] 45
                    ld        b,e                           ;[3bd5] 43
                    ...
                    ld        d,d                           ;[3bd7] 52
                    ld        d,l                           ;[3bd8] 55
                    call      $4c50                         ;[3bd9] cd 50 4c
                    ld        b,c                           ;[3bdc] 41
                    exx                                     ;[3bdd] d9
                    jp        $3c01                         ;[3bde] c3 01 3c
                    nop                                     ;[3be1] 00
                    nop                                     ;[3be2] 00
                    nop                                     ;[3be3] 00
                    nop                                     ;[3be4] 00
                    ...
                    rst       $38                           ;[3bff] ff
                    rst       $38                           ;[3c00] ff
                    jp        $39a0                         ;[3c01] c3 a0 39
                    jp        $3c10                         ;[3c04] c3 10 3c
                    jp        $3c10                         ;[3c07] c3 10 3c
                    jp        $3c10                         ;[3c0a] c3 10 3c
                    jp        $3c10                         ;[3c0d] c3 10 3c
                    ld        a,$7f                         ;[3c10] 3e 7f
                    in        a,($fe)                       ;[3c12] db fe
                    rra                                     ;[3c14] 1f
                    ret       c                             ;[3c15] d8
                    ...
                    out       ($fe),a                       ;[3c1e] d3 fe
                    ld        a,$02                         ;[3c20] 3e 02
                    call      $1601                         ;[3c22] cd 01 16
                    xor       a                             ;[3c25] af
                    ld        ($5c3c),a                     ;[3c26] 32 3c 5c
                    ld        a,$16                         ;[3c29] 3e 16
                    rst       $10                           ;[3c2b] d7
                    xor       a                             ;[3c2c] af
                    rst       $10                           ;[3c2d] d7
                    ...
                    add       d                             ;[3c3c] 82
                    dec       a                             ;[3c3d] 3d
                    ld        ($5c8f),a                     ;[3c3e] 32 8f 5c
                    ld        hl,$3c8f                      ;[3c41] 21 8f 3c
                    ld        c,e                           ;[3c44] 4b
                    ld        a,(hl)                        ;[3c45] 7e
                    rst       $10                           ;[3c46] d7
                    inc       hl                            ;[3c47] 23
                    dec       c                             ;[3c48] 0d
                    jr        nz,$3c45                      ;[3c49] 20 fa
                    djnz      $3c34                         ;[3c4b] 10 e7
                    ld        b,e                           ;[3c4d] 43
                    dec       d                             ;[3c4e] 15
                    jr        nz,$3c34                      ;[3c4f] 20 e3
                    ld        hl,$4800                      ;[3c51] 21 00 48
                    ld        d,h                           ;[3c54] 54
                    ld        e,l                           ;[3c55] 5d
                    inc       de                            ;[3c56] 13
                    xor       a                             ;[3c57] af
                    ld        (hl),a                        ;[3c58] 77
                    ld        bc,$0fff                      ;[3c59] 01 ff 0f
                    ldir                                    ;[3c5c] ed b0
                    ex        de,hl                         ;[3c5e] eb
                    ld        de,$5900                      ;[3c5f] 11 00 59
                    ld        bc,$0200                      ;[3c62] 01 00 02
                    ldir                                    ;[3c65] ed b0
                    di                                      ;[3c67] f3
                    ld        de,$0370                      ;[3c68] 11 70 03
                    ld        l,$07                         ;[3c6b] 2e 07
                    ld        bc,$0099                      ;[3c6d] 01 99 00
                    dec       bc                            ;[3c70] 0b
                    ld        a,b                           ;[3c71] 78
                    or        c                             ;[3c72] b1
                    jr        nz,$3c70                      ;[3c73] 20 fb
                    ld        a,l                           ;[3c75] 7d
                    xor       $10                           ;[3c76] ee 10
                    ld        l,a                           ;[3c78] 6f
                    out       ($fe),a                       ;[3c79] d3 fe
                    ...
                    ld        a,d                           ;[3c7c] 7a
                    or        e                             ;[3c7d] b3
                    jr        nz,$3c6d                      ;[3c7e] 20 ed
                    ld        bc,$0000                      ;[3c80] 01 00 00
                    dec       bc                            ;[3c83] 0b
                    ld        a,b                           ;[3c84] 78
                    or        c                             ;[3c85] b1
                    jr        nz,$3c83                      ;[3c86] 20 fb
                    dec       bc                            ;[3c88] 0b
                    ld        a,b                           ;[3c89] 78
                    or        c                             ;[3c8a] b1
                    jr        nz,$3c88                      ;[3c8b] 20 fb
                    jr        $3c68                         ;[3c8d] 18 d9
                    inc       de                            ;[3c8f] 13
                    nop                                     ;[3c90] 00
                    ld        sp,$1339                      ;[3c91] 31 39 13
                    ld        bc,$3638                      ;[3c94] 01 38 36
                    nop                                     ;[3c97] 00
                    nop                                     ;[3c98] 00
                    nop                                     ;[3c99] 00
                    nop                                     ;[3c9a] 00
