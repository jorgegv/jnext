...
**Read-back** (`zxnext.vhd:6084-6090`):
...
| RAM-BK-01| Read-back `NR 0x61`/`NR 0x62`/`NR 0x64`| fresh reset                 | `NR 0x61 <= 0x5A`; `NR 0x62 <= 0x86`; `NR 0x64 <= 0x40`; read each  | `NR 0x61` → `0x5A`; `NR 0x62` → `0x86` (mode=`10`, hi=`110` — **note mode=`10`**); `NR 0x64` → `0x40`.           | `zxnext.vhd:6084-6090`  |
