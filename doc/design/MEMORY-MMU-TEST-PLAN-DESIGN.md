...
| 11 (bits=11)      | 0x08 | 0x09 | 0x0E | 0x0F | 0x0C | 0x0D | 0x0E | 0x0F |
...
| SPE-04  | 11 (1FFD=0x07)    | 0x08 | 0x09 | 0x0E | 0x0F | 0x0C | 0x0D | 0x0E | 0x0F |
...
| ID      | Test                              | Setup                           | Expected                              |
|---------|-----------------------------------|---------------------------------|---------------------------------------|
| L2M-01  | L2 write-enable maps 0-16K       | port_123b write_en=1, seg=00    | Writes go to L2 bank, not ROM/MMU     |
