...
- [ ] Next-specific snapshot save/load format (design from scratch — only NEX exists today; needs own design doc + external/community comments; seed material in the G66 tombstone in [KNOWN-FUNCTIONALITY-GAPS-AND-PLAN.md](../issues/KNOWN-FUNCTIONALITY-GAPS-AND-PLAN.md); was Task 13a)
