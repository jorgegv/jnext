...
public:
    ...
    void reset() {
        ...
        // VHDL zxnext.vhd:5006-5008 — NR 0x43 b1-3 reset to '0'; NR 0x6B
        // bit 4 reset via nr_6b_tm_control <= (others => '0') (zxnext.vhd:5037).
...
private:
    ...
    bool    active_ula_palette_  = false; ///< NR 0x43 b1
    bool    active_l2_palette_   = false; ///< NR 0x43 b2
    bool    active_spr_palette_  = false; ///< NR 0x43 b3
    bool    active_tm_palette_   = false; ///< NR 0x6B b4
    ...
    /// Append a snapshot of NR 0x43 b1-3 to the change log.
    void log_palsel43_change();
    /// Append a snapshot of NR 0x6B b4 to the change log.
