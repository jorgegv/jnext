...
- SDL-only Windows variant (`make package-win-sdl`): no Qt, audited **Windows 8+** compatible (the Qt package needs Windows 10) — see `doc/design/WINDOWS-COMPAT-PLAN.md` (GH #108)
