...
| Debugger Video Panel  |       32 |       32 |      0 |       0 |    100% | 🟢 Task 22a (2026-07-12): new suite. Panel-vs-compositor parity — rom_in_sram bank shift, bank-pinned ULA views, per-scanline replay, raw-VC→fb-row. |
| **Total**             | **4169** | **4131** |  **0** |  **38** | **99%** | 🟡 38 SKIPs total (Rewind 10, Memory/MMU 22, NMI pipeline 5, port dispatch 1); 0 FAILs. |
