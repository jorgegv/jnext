...
unit-test: unit-test-build
	...
	TESTS="fuse_z80_test z80n_test rewind_test copper_test copper_integration_test mmu_test mmu_integration_test nextreg_test \
	       ...
	       uart_test uart_integration_test divmmc_test sdcard_test sd_rom_extractor_test sprites_test compositor_test compositor_integration_test ula_test ula_integration_test \
